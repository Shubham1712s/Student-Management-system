	...
	def __init__(self,root):
		...
		def add_data():
			if self.roll_no.get()=="" or self.name.get()==""  or self.father_name.get()=="" or self.contact.get()=="" or self.add_txt.get('1.0',END)=="" or len(self.contact.get())!=10:
				...
				con=pymysql.connect(host='localhost',user='root',password='Shubham@1712',database='student_management_system')
				cur=con.cursor()
...
img1=Image.open(r"C:\Users\Shubham\Desktop\student management\final project 2\login pAGE.png")
